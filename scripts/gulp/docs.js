...
function _copyUsageDocs() {
  return gulp.src( './components/**/usage.md' )
 ...
 */
function _copyCFJs() {
  return gulp.src( './components/capital-framework/capital-framework.min.js' )
 ...
 */
function _copyIcons() {
  return gulp.src( './components/cf-icons/src/icons/*.svg' )
